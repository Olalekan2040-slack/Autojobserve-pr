        ...
        while not done:
            ...
            for card in job_cards:
                ...
                try:
                    ...
                    job_entry['job description'] = driver.find_element(By.XPATH, '//*[@id="JobDesc1008744796758"]/div/div[2]/div/div/p[16]').text
                    job_entry['salary estimate'] = driver.find_element(By.XPATH, '//*[@id="JDCol"]/div/article/div/div[1]/div/div/div[1]/div[3]/div[1]/div[4]/span/span[1]').text
                except:
                      pass
...
def apply_for_job(driver):
    ...
    try:
        Jobalert = driver.find_element(By.XPATH,'//*[@id="JAModal"]/div/div[2]/span')
        Jobalert.click()
        time.sleep(3)
    except NoSuchElementException:
        print('#ERROR: no such element')
...
def main():
    ...
    result = fetch_jobs(driver_instance, KEYWORD, NUM_PAGES)
